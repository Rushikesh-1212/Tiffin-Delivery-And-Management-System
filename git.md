...
# it is assumed that the main/master branch contains
# - latest code
# - crash proof code
# - well tested code
# - bug free code
# the main branch is mostly used in CI/CD pipeline

# conflict
# - occurs when two branches update the same file on same line
...
# check if the repository is already connected to a remote repo
> git remote -v


# connect the local repository to remote one
# > git remote add <alias> <remote repo url>
> git remote add origin https://github.com/pythoncpp/dac-sept-24.git

# push all the changes (commit logs) to the remote repository
...
# when a new repository is initialized, a directory .git gets created
# this directory contains
# - HEAD: contains the name of current branch
# - config
# - description
# - objects
# - info
...
# object
# - encrypted file which stores version information
# - every object contains a unique id called as object id which is 40 bytes long
#   - out of the 40 bytes, first 2 byes are used to create a directory
#   - remaining 38 bytes are used to create a file
# - types
#   - blob object
#     - stores the contents of a file
#     - gets created when git add command is fired
#     - gets created per modified file
#   - tree object
#     - stores the mapping of file name and blob object(s)
#     - gets created per directory
#   - commit object
#     - stores the commit information
#     - only one commit object gets created per commit
#     - contains
#       - tree object id
